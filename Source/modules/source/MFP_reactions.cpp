...
Vector<Real> Recombination::recombination(const Vector<Real> &y0, const Vector<OffsetIndex> &offsets, Interp2D &dens_interp, Interp2D &R_interp, Interp2D &K_interp, Interp2D &W_interp, Interp2D &J_interp, const Real &bind_nrg)
{
